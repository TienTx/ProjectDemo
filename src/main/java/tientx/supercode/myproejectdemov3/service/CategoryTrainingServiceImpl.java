        ...
        implements CategoryTrainingService
{
    ...
    {
        try {
            lmc = (LMClassifier) AbstractExternalizable.readObject(new File(Variable.CATEGORY_CLASSIFFIER_FILE_NAME));
    ...
    public boolean train(String path)
    {
        try {
            ...
            AbstractExternalizable.compileTo((Compilable) lmc, new File(Variable.CATEGORY_CLASSIFFIER_FILE_NAME));
            return true;
        } catch (Exception e) {
            e.printStackTrace();
        }
